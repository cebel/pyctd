...
from pyctd.manager.defaults import DEFAULT_SQLITE_TEST_DATABASE_NAME, sqlalchemy_connection_string_4_tests
from pyctd.manager.models import (
    GeneAltGeneId,
    Pathway,
    DiseasePathway,
    Disease,
